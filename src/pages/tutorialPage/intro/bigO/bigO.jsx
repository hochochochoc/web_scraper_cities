...
export default function BigO() {
    ...
    const functions = [
      {
        ...
        fn: () => 1,
        color: "#4CAF50",
        labelPosition: { x: 171, y: 100 },
      },
      {
        name: "O(log n)",
        fn: (n) => Math.log2(Math.max(1, n)),
        color: "#2196F3",
        labelPosition: { x: 171, y: 70 },
      },
      {
        name: "O(n)",
        fn: (n) => n,
        color: "#FFC107",
        labelPosition: { x: 171, y: 50 },
      },
      {
        name: "O(n²)",
        fn: (n) => n * n,
        color: "#F44336",
        labelPosition: { x: 171, y: 15 },
      },
      {
        name: "O(n!)",
        fn: (n) => {
  ...
  return (
    <div className="mx-auto mt-3 w-full max-w-3xl rounded-lg bg-black/90 p-2">
      <p className="mb-4"></p>
